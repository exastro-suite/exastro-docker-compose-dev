...
| PLATFORM_VERSION                                  | Exastro Platform のバージョン                                                                                                                           | 可                            | 2.9.0                                                                                                               |
...
| ITA_VERSION                                       | Exastro IT Automation のバージョン                                                                                                                      | 可                            | 2.9.0                                                                                                               |
...
| ANSIBLE_AGENT_IMAGE_TAG                           | Ansible Agent のコンテナイメージのタグ                                                                                                                  | 不要                          | 2.9.0                                                                                                               |
