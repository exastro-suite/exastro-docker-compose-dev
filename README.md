...
| HTTP_PROXY                                        | HTTP 通信で使用するプロキシサーバーの URL（Podman のみ指定が必要）                                                                                      | 可                            | http://proxy.example.com:8080                                                                                                    |
| HTTPS_PROXY                                       | HTTPS 通信で使用するプロキシサーバーの URL（Podman のみ指定が必要）                                                                                     | 可                            | https://proxy.example.com:8443                                                                                                    |
