...
| HTTP_PROXY                                        | HTTP 通信で使用するプロキシサーバーの URL <br/>Podman のみ指定が必要です。コメントアウトを解除し、記載されているサンプル値を、必ず環境に合わせて修正してください。                                                                                      | 可                            | (サンプル値) http://proxy.example.com:8080                                                                                                                                                                                        |
| HTTPS_PROXY                                       | HTTPS 通信で使用するプロキシサーバーの URL <br/>Podman のみ指定が必要です。コメントアウトを解除し、記載されているサンプル値を、必ず環境に合わせて修正してください。                                                                                     | 可                            | (サンプル値) https://proxy.example.com:8443                                                                                                                                                                                       |
...
| PLATFORM_VERSION                                  | Exastro Platform のバージョン                                                                                                                           | 可                            | 1.12.0                                                                                                               |
...
| ITA_VERSION                                       | Exastro IT Automation のバージョン                                                                                                                      | 可                            | 2.8.0                                                                                                               |
...
| ANSIBLE_AGENT_IMAGE_TAG                           | Ansible Agent のコンテナイメージのタグ                                                                                                                  | 不要                          | 2.8.0                                                                                                               |
