...
| ORG_COMMON_MAINTENANCE_RECORDS_LIMIT_DESCRIPTION  | メニューエクスポート/インポートのバッファサイズの説明文表記                                                                                             | 不要                          | Maximum number of maintenance records processing for organization default |
